...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-zinc-900">
      <div className="relative flex justify-between align-center mx-auto max-w-3xl px-6 py-4 md:py-6 animate-fade-in-blur rounded-md text-zinc-300 bg-zinc-900/90 backdrop-blur-xl shadow-xs transition-all duration-300">
        <Link to='/'>Home</Link>
