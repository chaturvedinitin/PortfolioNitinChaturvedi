...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <div className="relative flex justify-between align-center mx-auto max-w-3xl px-6 py-4 md:py-6 animate-fade-in-blur rounded-md text-gray-300 bg-black/5 backdrop-blur-2xl shadow-xs transition-all duration-300">
        <Link to='/'>Home</Link>
